...
import SearchBarUniversal from "@/src/components/molecules/SearchBar";
import CustomerForm from "./CustomerForm";
import { getListCustomers, deleteCustomers } from "@/request/users";
import { getListClientsByName } from "@/lib/api-clients";
import CustomModalNoButton from "@/src/components/organisms/CustomModalNoButton";
import CustomerFormEdit from "./CustomerFormEdit";
import TableFilter from "@/src/components/molecules/TableFilter";
import EmptyState from '@/src/components/molecules/EmptyState'; // Import EmptyState component
